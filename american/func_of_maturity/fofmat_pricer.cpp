...
#include <iomanip>
#include <time.h>
#include "fofmat_pricer.h" // defines Matrix template to avoid seg fault
...
int main()
{
    ...
    maturities.open("maturities.txt");
    if (!maturities) {
        cerr << "Unable to open maturities.txt. \n";
        exit(1);
    }
