...
'''
EA is 0 for European, 1 for American
CP is 0 for put, 1 for call
S is the current price
K is the strike price
T is the time until expiration
sig is the volatility
r is the risk-free interest rate
a is the continuous dividend rate
M is the number of price steps
N is the number of time steps
'''
def op(EA, CP, S, K, T, sig, r, a, M, N):
